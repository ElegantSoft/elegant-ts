...
var ElegantController = /** @class */ (function () {
    function ElegantController(model, label) {
         ...
         * @param {res} Response
         */
        this.paginate = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, helpers_1.elegantPaginate(this.model, {}, page, limit, { created_at: -1 }, [], this.paginationSelectedItems || {})];
                    case 1:
                        data = _a.sent();
        ...
        this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newModel = req.body.newModel.newModel;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, res.status(200).json({ message: "created", model: createdModel })];
                    case 3:
                        error_2 = _a.sent();
                        console.log(error_2);
        ...
        this.renderCreatePage = function (req, res) {
            var title = "انشاء ";
            res.render("admin/" + _this.label + "/create", { title: title });
        };
        this.renderAdminIndex = function (req, res) {
            var title = "الكل";
            res.render("admin/" + _this.label + "/index", { title: title });
        };
        this.renderAdminEdit = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    ElegantController.prototype.test = function () {
